...
_DURABLE_INTENT_PATTERNS = [
    ...
    # Note: {owner} is runtime-substituted with owner_name variable
    re.compile(r"\b{owner}\b.*\bprefers?\b", re.IGNORECASE),
    re.compile(r"\b{owner}\b.*\bdecided\b", re.IGNORECASE),
    re.compile(r"\b{owner}\b.*\bconfirmed\b", re.IGNORECASE),
    re.compile(r"\b{owner}\b.*\bapproved\b", re.IGNORECASE),
    re.compile(r"\b{owner}\b.*\bcorrected\b", re.IGNORECASE),
    re.compile(r"\b{owner}\b.*\binstructed\b", re.IGNORECASE),
    re.compile(r"\b{owner}\b.*\brejected\b", re.IGNORECASE),
...
_WANTS_PATTERNS = [
    re.compile(r"\b{owner}\b.*\bwants?\s+to\b", re.IGNORECASE),
    re.compile(r"\bUser\b.*\bwants?\s+to\b", re.IGNORECASE),
    re.compile(r"\b{owner}\b.*\bwants?\b", re.IGNORECASE),
