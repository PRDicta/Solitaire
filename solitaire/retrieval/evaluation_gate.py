...
def _detect_artifact_creation(message: str) -> Optional[Tuple[str, str, List[str], str]]:
    """Detect if the user is requesting creation of an artifact.

    Returns:
        Tuple of (action_verb, artifact_type, subject_keywords, artifact_normalized) if detected.
