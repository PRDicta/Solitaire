...
class EmbeddingManager:
    ...
    def _find_onnx_model(self) -> Optional[str]:
        ...
        # Also check lib/models/ (standard deployment layout)
        candidates.append(os.path.join(script_dir, "lib", "models", model_name, "model.onnx"))
    ...
    def _embed_hash(self, text: str) -> List[float]:
        ...
        rng = np.random.default_rng(int.from_bytes(hash_bytes[:4], "big"))
